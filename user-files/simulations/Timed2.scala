...
class Timed2 extends Simulation {
	...
	val scn = scenario("Timed2")
		.exec(http("request_0")
			...
			.headers(headers_0)
			.body(RawFileBody("/timed2/0000_request.txt")))
		.pause(2)
		.exec(http("request_1")
		...
		.exec(http("request_2")
			...
			.put("/api/Cart/Add/")
			.headers(headers_3)
			.body(RawFileBody("/timed2/0003_request.json")),
            http("request_4")
			.put("https://" + uri2 + ":5001/api/Cart/Add/")
			.headers(headers_4)
			.body(RawFileBody("/timed2/0004_request.json"))))
		.pause(2)
		.exec(http("request_5")
			...
			.headers(headers_0)
			.body(RawFileBody("/timed2/0005_request.txt"))
			...
			.post("/api/Meridian/")
			.headers(headers_3)
			.body(RawFileBody("/timed2/0007_request.json")),
            http("request_8")
			.post("https://" + uri2 + ":5001/api/Meridian/")
			.headers(headers_4)
			.body(RawFileBody("/timed2/0008_request.json"))))
		.pause(3)
		.exec(http("request_9")
			...
			.put("/api/Cart/Event/")
			.headers(headers_3)
			.body(RawFileBody("/timed2/0010_request.json")),
            http("request_11")
			.put("https://" + uri2 + ":5001/api/Cart/Event/")
			.headers(headers_4)
			.body(RawFileBody("/timed2/0011_request.json")),
            http("request_12")
			...
			.headers(headers_0)
			.body(RawFileBody("/timed2/0012_request.txt"))))
		.pause(1)
		.exec(http("request_13")
			...
			.headers(headers_3)
			.body(RawFileBody("/timed2/0014_request.json")),
            http("request_15")
			.post("https://" + uri2 + ":5001/api/Booking/CreateTimed")
			.headers(headers_4)
			.body(RawFileBody("/timed2/0015_request.json"))))
		.pause(5)
		.exec(http("request_16")
			...
			.headers(headers_0)
			.body(RawFileBody("/timed2/0016_request.txt")))
		.pause(1)
		.exec(http("request_17")
			...
			.headers(headers_18)
			.body(RawFileBody("/timed2/0018_request.json")),
            http("request_19")
			.put("https://" + uri2 + ":5001/api/Booking/Details")
			.headers(headers_19)
			.body(RawFileBody("/timed2/0019_request.json")),
            http("request_20")
		...
		.exec(http("request_47")
			...
			.headers(headers_18)
			.body(RawFileBody("/timed2/0052_request.json")),
            http("request_53")
			...
			.headers(headers_19)
			.body(RawFileBody("/timed2/0055_request.json")),
            http("request_56")
			...
			.headers(headers_0)
			.body(RawFileBody("/timed2/0056_request.txt"))))
